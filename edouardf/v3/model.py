"""
v3 model — deeper architecture improvements over v2.
...
class CausalSelfAttention(nn.Module):
    ...
    def forward(self, x):
        ...
        # Add value embeddings before reshaping to heads
...
class Block(nn.Module):
    def __init__(self, n_embd, n_head, seq_len, dropout):
        ...
        # Per-layer learnable residual scaling
        self.lambda_attn = nn.Parameter(torch.ones(n_embd))
        self.lambda_mlp  = nn.Parameter(torch.ones(n_embd))
        # x0 residual: skip connection from initial embedding (starts at 0 = no effect)
